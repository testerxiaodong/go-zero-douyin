...
func newLike(db *gorm.DB, opts ...gen.DOOption) like {
	...
	_like.CreateTime = field.NewInt64(tableName, "create_time")
	_like.UpdateTime = field.NewInt64(tableName, "update_time")
	_like.DeleteTime = field.NewField(tableName, "delete_time")
...
func (l *like) updateTableName(table string) *like {
	...
	l.DeleteTime = field.NewField(table, "delete_time")
