...
import (
	...
	"go-zero-douyin/apps/like/cmd/rpc/internal/server"
...
var configFile = flag.String("f", "etc/likerpc.yaml", "the config file")
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		pb.RegisterLikerpcServer(grpcServer, server.NewLikerpcServer(ctx))
