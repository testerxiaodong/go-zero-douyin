...
func newSection(db *gorm.DB, opts ...gen.DOOption) section {
	...
	_section.CreateTime = field.NewInt64(tableName, "create_time")
	_section.UpdateTime = field.NewInt64(tableName, "update_time")
	_section.DeleteTime = field.NewField(tableName, "delete_time")
