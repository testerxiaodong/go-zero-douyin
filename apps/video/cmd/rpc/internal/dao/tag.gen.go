...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.CreateTime = field.NewInt64(tableName, "create_time")
	_tag.UpdateTime = field.NewInt64(tableName, "update_time")
	_tag.DeleteTime = field.NewField(tableName, "delete_time")
