...
func SyncVideoToEsByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SyncVideoToEsByIdReq
		if err := httpx.Parse(r, &req); err != nil {
			httpResponse.ParamErrorResult(r, w, err)
			return
		}

		l := video.NewSyncVideoToEsByIdLogic(r.Context(), svcCtx)
		err := l.SyncVideoToEsById(&req)
